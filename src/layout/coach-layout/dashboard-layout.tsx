...
const mobileLinks = [
  { title: "Home", url: "/coach/dashboard/" },
  { title: "Favorite", url: "/coach/favorite/" },
  { title: "Profile", url: "/coach/profile/" },
  { title: "Settings", url: "/coach/settings/" },
  { title: "Logout", url: "/" },
];
...
export default function ClippedDrawer({ children }: { children: ReactNode }) {
  ...
  const isHidden = pathname === "/coach/settings/";

...
const centerLinks = [
  ...
  {
    title: "Profile",
    fill: <AccountCircleIcon sx={{ color: "white" }} />,
...
const mobileLinks = [
  { title: "Home", url: "/player/dashboard/" },
  { title: "Feed", url: "/player/feed/" },
  // { title: "Notification", url: "/dashboard/favorite/" },
  // { title: "Message", url: "/dashboard/favorite/" },
  { title: "Profile", url: "/player/profile/" },
  { title: "Settings", url: "/player/settings/" },
  { title: "Logout", url: "/" },
];
...
export default function ClippedDrawer({ children }: { children: ReactNode }) {
  ...
  const isHidden = pathname === "/player/settings/";
